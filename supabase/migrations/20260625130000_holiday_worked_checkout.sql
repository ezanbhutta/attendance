-- ════════════════════════════════════════════════════════════════════════════
-- Holiday volunteers (HolidayWorked) follow the working-day check-out rule.
--
-- A bonus day was being closed at the person's LAST scan, so someone who scanned
-- in once (e.g. a night-shift volunteer at 01:36) showed check-out = 01:36 and 0
-- worked. A volunteer is actually working, so their day must use the normal
-- check-out: the last scan at/after the shift end, or — if they never scan out —
-- the shift end itself, four hours later. Their hours are then correct (e.g. a
-- 01:00-09:00 shift auto-closes at 09:00). Late and overtime stay off on a bonus
-- day; the reward is the flat bonus day.
-- ════════════════════════════════════════════════════════════════════════════

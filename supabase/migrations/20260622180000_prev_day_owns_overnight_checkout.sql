-- ════════════════════════════════════════════════════════════════════════════
-- A scan in the early hours belongs to the PREVIOUS night, not to today.
--
-- An evening / night shift that crosses midnight (e.g. CSR Evening 17:00→01:00,
-- or a 01:00→09:00 night that counts for the day before) is checked out in the
-- small hours of the NEXT calendar day. The overnight window already files that
-- checkout under the day the shift started — but the next day was ALSO picking it
-- up (by calendar date), so a weekly-off / ordinary day wrongly showed that lone
-- scan as attendance.
--
